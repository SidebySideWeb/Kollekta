...
Μετά το **14** έχεις λειτουργικό προϊόν. Μετά το **16** έχεις image για πολλαπλά instances. Μετά το **19** έχεις provisioning με ένα κλικ. Τα **20–22** είναι προσθετικά και τρέχουν όποτε τα χρειαστείς.
